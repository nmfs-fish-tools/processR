...
public:
     ...
     */
    inline iterator insert(const_iterator pos, const double& value) {
     ...
     */
    inline iterator insert(const_iterator pos, size_type count, const double& value) {
    ...
    inline iterator insert(const_iterator pos, std::initializer_list<double> ilist) {
     ...
     */
    inline void swap(SharedVector& other) {
