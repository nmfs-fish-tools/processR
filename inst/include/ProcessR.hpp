...
// typedef allocator<ValueType, managed_shared_memory::segment_manager> ShmemAllocator2;
// 
...
//     const ShmemAllocator alloc_inst(segment.get_segment_manager());
//     
//     //Construct a vector named "MySHMMap" in shared memory with argument alloc_inst
//     this->map_m = segment.construct<MySHMMap>("MySHMMap")(std::less<KeyType>(), alloc_inst);
//     
//   }
//   
// public:
...
//     
//     //Find the vector using the c-string name
//     this->map_m = segment.find<MySHMMap>("MySHMMap").first;
//   }
//   
//   void destroy(const std::string& name) {
//     this->segment.destroy<REALSMVector>(name.c_str());
